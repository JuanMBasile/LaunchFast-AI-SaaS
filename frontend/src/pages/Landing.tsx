      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-28 sm:pb-32">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-1.5 bg-primary-50 text-primary-700 px-3 py-1 rounded-full text-xs font-semibold tracking-wide mb-6 border border-primary-100">
            ...
            <div className="flex items-center justify-center gap-5 mt-7 text-xs text-stone-400">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[0, 1, 2, 3].map((i) => {
              ...
              return (
                <div
                  key={i}
                  className="bg-white rounded-xl border border-stone-200/80 p-5 shadow-sm shadow-stone-900/2 hover:shadow-md hover:shadow-stone-900/5 transition-all duration-200"
                >
