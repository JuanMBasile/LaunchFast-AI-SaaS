...
export default function CreditsIndicator() {
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-stone-200/80 bg-stone-50/50 px-3.5 py-2.5">
      <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-100">
        <Zap className="h-4 w-4 text-primary-600" />
      </div>
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          <span className="text-xs font-medium text-stone-500">{t('common.credits')}</span>
